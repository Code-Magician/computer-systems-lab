...
unsigned int compile_and_link_shaders(const char* fragmentShaderSource);
...
int main()
{
  ...
  shaderProgram1 = compile_and_link_shaders(fragmentShaderSource1);
  shaderProgram2 = compile_and_link_shaders(fragmentShaderSource2);

  unsigned int VAO1, VAO2;
  VAO1 = generate_and_send_triangle_data_to_gpu(vertices1, sizeof(vertices1));
  VAO2 = generate_and_send_triangle_data_to_gpu(vertices2, sizeof(vertices2));  
